document.addEventListener("DOMContentLoaded", function() {
  ...
  // Array of Track URLs
  const trackList = [
    "audios/Metamorphosis.mp3",
    
    "audios/One Chance.mp3",
    
    "audios/Memory Reboot.mp3",
  ...
  const albumPhotos = [
    ...
    "https://imgs.search.brave.com/4VlCzR18CbNK1F7c2Qs1NEDX8GKVRXILRFaJE5flbrI/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9sYXN0/Zm0uZnJlZXRscy5m/YXN0bHkubmV0L2kv/dS81MDB4NTAwLzk5/ZTIyZTRiMTRhNjI1/ZGNkYTQwNGIyOWZi/OTFkMzc5LmpwZw"
  ];
